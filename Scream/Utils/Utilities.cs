...
namespace Scream
{
    ...
    class Utilities
    {
        ...
        private static void AddMissingKeysForVless(Dictionary<string, object> outbound, Dictionary<string, object> template)
        {
            Queue<Dictionary<string, object>> outboundQueue = new Queue<Dictionary<string, object>>();
            outboundQueue.Enqueue(outbound);
            Queue<Dictionary<string, object>> templateQueue = new Queue<Dictionary<string, object>>();
        ...
        private static void AddMissingKeysForTrojan(Dictionary<string, object> outbound, Dictionary<string, object> template)
        {
            Queue<Dictionary<string, object>> outboundQueue = new Queue<Dictionary<string, object>>();
            outboundQueue.Enqueue(outbound);
            Queue<Dictionary<string, object>> templateQueue = new Queue<Dictionary<string, object>>();
        ...
        private static void AddMissingKeysForShadowsocks(Dictionary<string, object> outbound, Dictionary<string, object> template)
        {
            Queue<Dictionary<string, object>> outboundQueue = new Queue<Dictionary<string, object>>();
            outboundQueue.Enqueue(outbound);
            Queue<Dictionary<string, object>> templateQueue = new Queue<Dictionary<string, object>>();
        ...
        public static List<string> NETWORK_LIST = new List<string> { @"tcp", @"kcp", @"ws", @"http", @"quic", @"grpc" };
        ...
        {
            return javaScriptSerializer.Deserialize<dynamic>(Scream.Properties.Resources.vmessjson);
        }
        public static Dictionary<string, object> VlessOutboundTemplate()
        {
            return javaScriptSerializer.Deserialize<dynamic>(Scream.Properties.Resources.vlesstemplate);
        }
        //Only used as completion, no tls&flow
        public static Dictionary<string, object> VlessOutboundJson()
        {
            return javaScriptSerializer.Deserialize<dynamic>(Scream.Properties.Resources.vlessjson);
        }
        public static Dictionary<string, object> TrojanOutboundJson()
        {
            return javaScriptSerializer.Deserialize<dynamic>(Scream.Properties.Resources.trojanjson);
        }
        public static Dictionary<string, object> ShadowsocksOutboundJson()
        {
            return javaScriptSerializer.Deserialize<dynamic>(Scream.Properties.Resources.shadowsocksjosn);
        }

        //Sharelink import 
        public static Dictionary<string, object> VmessOutboundTemplateNew()
        {
            return javaScriptSerializer.Deserialize<dynamic>(Scream.Properties.Resources.vmesstemplate);
        }
        //Sharelink import
        public static Dictionary<string, object> ShadowsocksOutboundTemplateNew()
        {
            return javaScriptSerializer.Deserialize<dynamic>(Scream.Properties.Resources.shadowsockstemplate);
        }
